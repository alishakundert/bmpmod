...
def gen_mock_data(clusterID, N_ne=50, N_temp=10, noise_ne=0.01, noise_temp=0.05, refindex= -1, incl_mstar=0,incl_mgas=1):
    ...
    table_reff=atpy.Table.read('./exampledata/table_bcg_reff.txt',format='ascii')
